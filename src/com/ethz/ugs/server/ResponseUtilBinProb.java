...
public class ResponseUtilBinProb {
			...
			IllegalBlockSizeException, BadPaddingException
	{
		...
		else
		{
			...
			byte[] dummy = new byte[toSendDummy.length + toSendDummy_1.length + toSendDummy_2.length + toSendDummy_3.length +
			                        toSendDummy_4.length + toSendDummy_5.length];
			int tillNow = 0;
