...
public class GraphPanel extends JPanel {
    ...
    public GraphPanel(List<Long> scores1, List<Long> scores2) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        draw(g, this.scores1, new Color(0, 102, 230, 180), new Color(100, 100, 100, 180));
        //draw(g, this.scores2, new Color(255, 0, 0, 180), new Color(0, 0, 100, 180));
       // draw(g);
    }
    
    private void draw(Graphics g,List<Long> scores1, Color lineColor, Color pointColor)
    {
...
//    }
    ...
    private static void createAndShowGui() throws NumberFormatException, IOException {
        List<Long> scores1 = new ArrayList<>();
        List<Long> scores2 = new ArrayList<>();
        
        BufferedReader br = new BufferedReader(new FileReader("MainServer.log.14"));
		...
		BufferedReader br1 = new BufferedReader(new FileReader("MainServer.log.8"));
		...
		List<Long> _scores1 = scores1.subList(0, 5000);
		List<Long> _scores2 = scores2.subList(0, 5000);
		
        GraphPanel mainPanel = new GraphPanel(_scores1, _scores2);
